  ...
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden"
      ...
      <div className="relative z-10 text-center px-6 max-w-3xl mx-auto">
        ...
        >
          <p className="text-white/70 tracking-[0.3em] uppercase text-sm font-light mb-6">
            Arte & Tradición Argentina
          </p>

          <h1 className="text-6xl md:text-8xl font-light text-zinc-900 mb-6" style={{ fontFamily: 'Cormorant Garamond, serif' }}>
            Ópalo
          </h1>

          <h2 className="text-3xl md:text-4xl font-light text-zinc-800 mb-4" style={{ fontFamily: 'Cormorant Garamond, serif' }}>
            Creaciones
          </h2>

          <div className="w-16 h-[1px] bg-white/50 mx-auto my-8" />

          <p className="text-zinc-700 text-lg font-light leading-relaxed max-w-lg mx-auto">
        ...
        >
          <button
            ...
            className="group inline-flex flex-col items-center gap-2 text-dark/60 hover:text-white transition-colors"
          >
